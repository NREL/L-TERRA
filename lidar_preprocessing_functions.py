...
def import_WC_file(filename):
    ...
    for i in range(1,len(heights)+1):
        try:
            u.append(-np.genfromtxt(filename, delimiter='\t',usecols=(i*9 + 1),dtype=None,skiprows=num_rows,skip_footer=footer_lines))
            v.append(-np.genfromtxt(filename, delimiter='\t', usecols=(i*9),dtype=None,skiprows=num_rows,skip_footer=footer_lines))
            w.append(-np.genfromtxt(filename, delimiter='\t', usecols=(i*9 + 2),dtype=None,skiprows=num_rows,skip_footer=footer_lines))
        except:
            u.append(v_nan)
            v.append(v_nan)
            w.append(v_nan)
...
def import_WC_file_VAD(filename,height_needed):
    ...
    az_angle = np.genfromtxt(filename, delimiter='\t', usecols=(1,),dtype=str, unpack=True,skiprows=num_rows,skip_footer=footer_lines)
    ...
    for i in range(1,len(heights)+1):
        try:
            vr.append(-np.genfromtxt(filename, delimiter='\t', usecols=(i*9 -4),dtype=None,skiprows=num_rows,skip_footer=footer_lines))
        except:
            vr.append(vr_nan)
    ...
    for i in range(0,len(az_temp)/4):
...
def import_ZephIR_file(filename):
    ...
    #Read in timestamps
    num_rows = 2
    timestamp = np.loadtxt(filename, delimiter=',', usecols=(1,),dtype=str, unpack=True,skiprows=num_rows) 
    ...
    for i in range(0,len(heights)):
        try:
            if i == 0:
                wd = np.genfromtxt(filename, delimiter=',',usecols=(19 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)
                ws = np.genfromtxt(filename, delimiter=',', usecols=(20 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)
                w = np.genfromtxt(filename, delimiter=',', usecols=(21 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)
            else:
                wd = np.vstack((wd,np.genfromtxt(filename, delimiter=',',usecols=(19 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)))
                ws = np.vstack((ws,np.genfromtxt(filename, delimiter=',', usecols=(20 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)))
                w = np.vstack((w,np.genfromtxt(filename, delimiter=',', usecols=(21 + i*3),dtype=None,skiprows=num_rows,skip_footer=footer_lines)))
        except:
            if i == 0:
                wd = v_nan
                ws = v_nan
